...
@component('layouts.app')
                    ...
                    <div class="slider__content__wrapper sm:text-center h-full z-3">
                        ...
                        <div class="slider__content  is-active  js-slider-content">
                            <div data-split="lines">
                                <p
                                    class="slider__subtitle text-sm uppercase tracking-md leading-md mb-32 js-subtitle text__primary">
                                    Root Over Flow
                                </p>
                            </div>
    ...
    <section class="layout-pt-lg layout-pb-lg">
        ...
        <div class="container">
            <div data-cursor="" data-cursor-label="DRAG"
                ...
                <div
                    class="pagination -dark js-pagination pt-4 mb-48 swiper-pagination-clickable swiper-pagination-bullets">
                ...
                <div class="swiper-wrapper"
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next"
                        data-swiper-slide-index="2" style="width: 1328px;">
                        <div class="row justify-content-center">
                            <div class="col-lg-9 col-md-10">
                                <div class="testimonials text-center">
                                    <p
                                        class="testimonials__comment text-3xl md:text-2xl sm:text-xl fw-500 leading-xl text-black">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev"
                        data-swiper-slide-index="0" style="width: 1328px;">
                        <div class="row justify-content-center">
                            <div class="col-lg-9 col-md-10">
                                <div class="testimonials text-center">
                                    <p
    ...
    <section class="layout-pt-lg layout-pb-lg">
        ...
        <div class="container">
            ...
            <section class="row x-gap-48 y-gap-48 layout-pt-md mobile-show slider-team">
